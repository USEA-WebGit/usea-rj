...
<div class="mb-5 md:left-0 md:mt-5 hidden lg:block">
    <div class="w-fit sticky top-0 rounded-3xl bg-white p-6 shadow-md">
      ...
      <div class="relative w-7/12 h-10 bg-gray-200 text-usea_primary font-hanuman md:text-xl text-nowrap mx-auto text-sm sm:text-base mt-3 rounded-lg ">
      ...
      <div class="mt-4 border-t-2 font-hanuman md:text-xl lg:text-xl xl:text-2xl text-nowrap mx-auto h-full w-full text-sm sm:text-base">
      ...
      <div class="flex text-usea_primary items-center text-left p-2 text-sm sm:lg md:text-xl"><i class="fa-solid fa-envelope"></i><div class="ml-2 md:ml-3">usea.rj@usea.edu.kh</div></div>
